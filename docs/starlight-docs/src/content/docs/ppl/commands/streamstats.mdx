...
<PlaygroundLink query="%7C%20where%20severityText%20%3D%20!%27ERROR!%27%20%7C%20sort%20time%20%7C%20streamstats%20count%28%29%20as%20cumulative_errors%20by%20%60resource.attributes.service.name%60%20%7C%20head%20100" />
