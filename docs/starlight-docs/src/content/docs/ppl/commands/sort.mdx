...
<PlaygroundLink query="%7C%20sort%20severityNumber" />
...
<PlaygroundLink query="%7C%20sort%20-%20severityNumber" />
...
<PlaygroundLink query="%7C%20sort%20%2B%20%60resource.attributes.service.name%60%2C%20-%20severityNumber" />
...
<PlaygroundLink query="%7C%20sort%20%60resource.attributes.service.name%60%20asc%2C%20severityNumber%20desc" />
...
<PlaygroundLink query="%7C%20sort%202%20-%20time" />
...
<PlaygroundLink query="%7C%20sort%20str%28severityNumber%29" />
...
<PlaygroundLink query="%7C%20where%20severityText%20%3D%20!%27ERROR!%27%20%7C%20sort%20-%20time%20%7C%20head%2020" />
