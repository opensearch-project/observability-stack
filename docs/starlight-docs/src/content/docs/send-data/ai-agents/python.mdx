...
pip install "opensearch-genai-observability-sdk-py[google]"
...
pip install "opensearch-genai-observability-sdk-py[all]"                 # everything (instrumentors + dev)
```
...
| `Benchmark` | Upload pre-computed eval results | [Evaluation & Scoring](/docs/ai-observability/evaluation/#benchmark---upload-pre-computed-results) |
| `EvalScore` | Scorer return type | [Evaluation & Scoring](/docs/ai-observability/evaluation/#evalscore-dataclass) |
| `BenchmarkResult` | Result from `evaluate()` | [Evaluation & Scoring](/docs/ai-observability/evaluation/#result-types) |
| `BenchmarkSummary` | Aggregate score statistics | [Evaluation & Scoring](/docs/ai-observability/evaluation/#result-types) |
| `TestCaseResult` | Per-case result | [Evaluation & Scoring](/docs/ai-observability/evaluation/#result-types) |
| `ScoreSummary` | Per-metric statistics | [Evaluation & Scoring](/docs/ai-observability/evaluation/#result-types) |
...
For running evaluations at scale (`evaluate()`, `Benchmark`, `OpenSearchTraceRetriever`), see [Evaluation & Scoring](/docs/ai-observability/evaluation/).
