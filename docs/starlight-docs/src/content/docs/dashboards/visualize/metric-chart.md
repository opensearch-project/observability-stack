...
![Metric chart displaying the last average ticket price](/docs/images/dashboards/visualization-editor/metric-chart-basic-result.png)
...
| Setting | Description |
| --- | --- |
| **Calculation** | Determines how multiple data points are reduced to a single value. Supported values: **Last \***, **Last**, **First \***, **First**, **Min**, **Max**, **Median**, **Variance**, **Distinct count**, **Count**, **Total**. For more information, see [Value calculations](/docs/dashboards/visualize/configuring-visualizations/value-calculations/). |
