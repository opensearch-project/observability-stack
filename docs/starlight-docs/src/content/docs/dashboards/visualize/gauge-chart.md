...
The following examples build on each other, starting with a basic gauge and adding complexity.
...
![Initial gauge chart showing the last average ticket price](/docs/images/dashboards/visualization-editor/gauge/gauge-initial-look.png)
...
![Gauge chart with color-coded threshold bands](/docs/images/dashboards/visualization-editor/gauge/gauge-with-thresholds.png)
...
![Gauge chart with custom min/max scale](/docs/images/dashboards/visualization-editor/gauge/gauge-custom-scale.png)
