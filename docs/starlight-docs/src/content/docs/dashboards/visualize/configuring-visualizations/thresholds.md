...
- [Area chart](/docs/dashboards/visualize/area-chart/)
- [Bar chart](/docs/dashboards/visualize/bar-chart/)
- [Bar gauge chart](/docs/dashboards/visualize/bar-gauge-chart/)
- [Gauge chart](/docs/dashboards/visualize/gauge-chart/)
- [Heatmap chart](/docs/dashboards/visualize/heatmap-chart/)
- [Line chart](/docs/dashboards/visualize/line-chart/)
- [Scatter chart](/docs/dashboards/visualize/scatter-chart/)
- [State timeline chart](/docs/dashboards/visualize/state-timeline-chart/)
...
![Gauge chart with threshold colors applied](/docs/images/dashboards/visualization-editor/gauge-chart-thresholds.png)
...
![Line chart with dashed threshold line at 20](/docs/images/dashboards/visualization-editor/line-chart-threshold-lines.png)
...
![Scatter chart with threshold colors applied showing the configuration panel](/docs/images/dashboards/visualization-editor/scatter-threshold-full-ui.png)
