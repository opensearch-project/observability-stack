...
![Split visualization showing separate line charts for each machine.os value](/docs/images/dashboards/visualization-editor/split-example.png)
...
| Setting | Description |
| --- | --- |
| **Calculation** | The function used to reduce a series to a single value (for example, Last, Mean, Max, Min). For details, see [Value calculations](/docs/dashboards/visualize/configuring-visualizations/value-calculations/). |
...
Thresholds define color-coded boundaries that indicate when values cross important limits. For details, see [Thresholds](/docs/dashboards/visualize/configuring-visualizations/thresholds/).

## Value calculations

Value calculations determine how a series of values is reduced to a single number for display (for example, Last, Mean, Sum, Min, Max). For details, see [Value calculations](/docs/dashboards/visualize/configuring-visualizations/value-calculations/).
