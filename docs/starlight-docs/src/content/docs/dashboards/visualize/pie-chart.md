...
![Donut chart showing count by carrier](/docs/images/dashboards/visualization-editor/pie-chart-donut-result.png)
...
![Pie chart settings with Pie mode, show values, and show labels enabled](/docs/images/dashboards/visualization-editor/pie-chart-settings-custom.png)
...
![Pie chart with labels and values shown](/docs/images/dashboards/visualization-editor/pie-chart-labels-result.png)
