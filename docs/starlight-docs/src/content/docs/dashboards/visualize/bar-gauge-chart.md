...
![Basic bar gauge showing average bytes by operating system](/docs/images/dashboards/visualization-editor/bar-gauge/bar-gauge-initial.png)
...
![Bar gauge with gradient display style](/docs/images/dashboards/visualization-editor/bar-gauge/bar-gauge-gradient.png)

**Stack**---Each bar is divided into distinct colored segments at threshold boundaries, as shown in the following image.

![Bar gauge with stack display style](/docs/images/dashboards/visualization-editor/bar-gauge/bar-gauge-stack.png)
...
![Bar gauge with basic display style](/docs/images/dashboards/visualization-editor/bar-gauge/bar-gauge-basic.png)
