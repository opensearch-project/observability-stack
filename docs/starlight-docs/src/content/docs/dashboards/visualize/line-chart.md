...
The following examples build on each other, starting with a basic chart and adding complexity. They use the sample web log dataset.
...
![Basic line chart showing event count per hour](/docs/images/dashboards/visualization-editor/line-chart-basic-result.png)
...
![Multi-series line chart showing counts by HTTP response code](/docs/images/dashboards/visualization-editor/line-chart-multi-series.png)
...
![Line chart with two Y-Axis metrics plotted together](/docs/images/dashboards/visualization-editor/line-chart-multiple-y-result.png)
...
![Dual-axis chart with avg(bytes) as line and max(bytes) as bars](/docs/images/dashboards/visualization-editor/line-chart-dual-axis-result.png)
