...
![Basic area chart showing count over time](/docs/images/dashboards/visualization-editor/area-chart-basic-result.png)
...
![Stacked area chart showing counts by HTTP response code](/docs/images/dashboards/visualization-editor/area-chart-stacked-result.png)
