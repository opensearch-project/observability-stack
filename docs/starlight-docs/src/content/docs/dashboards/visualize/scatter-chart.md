...
The following examples build on each other, starting with a basic two-variable scatter and adding dimensions.
...
![Basic scatter chart showing average flight price compared to distance](/docs/images/dashboards/visualization-editor/scatter/scatter-two-num-fields.png)
...
![Scatter chart with threshold at 6000 highlighting long-distance flights](/docs/images/dashboards/visualization-editor/scatter/scatter-with-threshold.png)

For more information, see [Thresholds](/docs/dashboards/visualize/configuring-visualizations/thresholds/).
...
![Scatter chart with color-coded weather categories](/docs/images/dashboards/visualization-editor/scatter/scatter-two-numerical-one-cate-fields.png)
...
![Scatter chart with size representing flight delay minutes](/docs/images/dashboards/visualization-editor/scatter/scatter-two-numerical-one-cate-fields-one-size.png)
...
In the **Split by** dropdown list, select a field to split the chart into separate elements by value. For more information, see [Split](/docs/dashboards/visualize/configuring-visualizations/#split).
...
For information about configuring thresholds, see [Thresholds](/docs/dashboards/visualize/configuring-visualizations/thresholds/).

### Axes

The X-axis and Y-axis share the same configuration options. For more information, see [Axes](/docs/dashboards/visualize/configuring-visualizations/#axes).
