...
The following examples build on each other, starting with a basic heatmap and adding complexity.
...
![Basic heatmap showing average flight delay minutes by weather conditions](/docs/images/dashboards/visualization-editor/heatmap/heatmap-initial.png)
...
![Heatmap with customized color schema and scale](/docs/images/dashboards/visualization-editor/heatmap/heatmap-custom-colors.png)
...
![Heatmap with value labels displayed in cells](/docs/images/dashboards/visualization-editor/heatmap/heatmap-with-labels.png)
