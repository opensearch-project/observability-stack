...
The following examples build on each other, starting with a basic chart and adding complexity.
...
![Basic bar chart showing count by carrier](/docs/images/dashboards/visualization-editor/bar-chart-basic-result.png)
...
![Grouped bar chart showing count by carrier and cancellation status](/docs/images/dashboards/visualization-editor/bar-chart-grouped-result.png)
...
![Bar chart settings with threshold configured at 200](/docs/images/dashboards/visualization-editor/bar-chart-threshold-settings.png)
...
![Bar chart with threshold coloring and dashed reference line at 200](/docs/images/dashboards/visualization-editor/bar-chart-threshold-result.png)
