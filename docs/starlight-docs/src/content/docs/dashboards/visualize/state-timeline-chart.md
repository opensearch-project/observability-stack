...
The following examples build on each other, starting with a basic timeline and adding complexity.
...
![Basic state timeline showing request changes over time](/docs/images/dashboards/visualization-editor/state-timeline/state-timeline-single-cate-field.png)
...
![Value mappings options](/docs/images/dashboards/visualization-editor/state-timeline/value-mapping-for-reponse.png)
...
![State timeline with value mappings applied](/docs/images/dashboards/visualization-editor/state-timeline/state-timeline-value-mapping.png)
...
![State timeline with disconnect threshold settings](/docs/images/dashboards/visualization-editor/state-timeline/disconnect-threshold.gif)
...
![State timeline grouped by request](/docs/images/dashboards/visualization-editor/state-timeline/state-timeline-grouped.png)
