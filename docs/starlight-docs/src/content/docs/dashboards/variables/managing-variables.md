...
![Manage variables panel displaying variable names, types, and action icons](/docs/images/dashboard-variables/manage_panel.png)
...
- [Using dashboard variables](/docs/dashboards/variables/using-variables/)
