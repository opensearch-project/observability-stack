...
1. Select a variable from the list or continue typing to filter, as shown in the following image.
   ...
   ![Query editor showing autocomplete dropdown with available dashboard variables](/docs/images/dashboard-variables/variable_autocomplete.png)
...
1. Filter by a variable value:
   ...
   ![Visualization editor showing average memory over time filtered by machine_os set to win 8](/docs/images/dashboard-variables/filter_case_variable.png)
...
1. Use the variable in a visualization:
   ...
   ![Visualization editor showing average memory over time with the log_metric variable set to memory](/docs/images/dashboard-variables/metrics_case_variable.png)
...
1. Use the variable in a visualization:
   ...
   ![Visualization editor showing avg_bytes and max_bytes over time with the interval variable set to 1d](/docs/images/dashboard-variables/interval_case_variable.png)
...
1. Use the variable in a visualization:
   ...
   ![Visualization editor showing average memory over time with the function variable set to avg](/docs/images/dashboard-variables/function_case_variable.png)
