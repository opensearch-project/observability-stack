...
This example demonstrates how to instrument a LangChain agent application with OpenTelemetry to send telemetry data to the ATLAS observability stack using OTLP protocol.
...
- **OTLP Export**: Sends traces to ATLAS stack via gRPC
...
4. Spans are batched and exported via OTLP to the ATLAS observability stack
...
1. Check ATLAS stack is running: `docker-compose ps`
